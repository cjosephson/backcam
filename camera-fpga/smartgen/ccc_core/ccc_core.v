...
output SDOUT;
    ...
    DYNCCC #( .VCOFREQUENCY(50.000) )  Core (.CLKA(CLKA), .EXTFB(GND), 
        ...
        SDOUT), .OADIV0(GND), .OADIV1(GND), .OADIV2(GND), .OADIV3(GND), 
        ...
        .FBDIV0(VCC), .FBDIV1(GND), .FBDIV2(GND), .FBDIV3(VCC), 
...
// MGNTIMER:F
// MGNCMPL:T
// DESDIR:C:/Users/pyzhang/Desktop/working/backscatter-fpga/smartgen\ccc_core
// GEN_BEHV_MODULE:F
